...
class MyHTMLLayer(torch.nn.Module):
    ...
    def forward(self, hand_params, handle_collision=True):
        ...
        # vertices,joints = self.html.get_mano_vertices(rotation, hand_params['pose_params'], hand_params['shape_params'], scale_and_trans)

        new_tex_img = self.html.get_mano_texture(hand_params['texture_params'])
