...
from network.freihandnet import MyPoseHand, HM2Mano, normal_init#, mesh2poseNet
from network.net_hg import Net_HM_HG
    ...
    def predict_singleview(self, images, mask_images, Ks, task, requires, gt_verts, bgimgs):
        ...
        if self.regress_mode == 'hm2mano' or task == 'hm_train' or 'heatmaps' in requires:
            ...
            for est_hm in est_hm_list:
                est_pose_uv = visualize_util.compute_uv_from_integral(est_hm, images_this.shape[2:4])#check
